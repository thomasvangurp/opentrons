...
from opentrons.pubsub_util.topics import POSITION_MOVED
from opentrons.pubsub_util.messages.position import pos_moved_msg
...
class PositionTracker(object):
    def __init__(self, message_broker: MessageBroker):
        self._position_dict = {}
        message_broker.subscribe(POSITION_MOVED, self._object_moved_event)
    ...
    def _object_moved_event(self, new_position: pos_moved_msg):
